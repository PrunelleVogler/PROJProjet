...
# file_name = "branch_and_cut-comparaison-méthodes"*string(time_limit)*"s.txt"
...
for instance in list_instances
    ...
    upper_bound, lower_bound, execution_time = bac_algorithm(instance_name, time_limit)
